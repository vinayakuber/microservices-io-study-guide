...
//    alt no slices : every layer of every subdomain rebuilds -> tests_run : 20 -> 200`,
  ...
  systemDesign: {
    question: 'Design the deployment for a small application. Premise: the monolith is one process with presentation, business logic, and data access tiers all hitting one database, so changes deploy as one unit and scale as one unit.',
