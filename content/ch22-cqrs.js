...
// <- outcome : view_db : { id:"C-42", total:95.00 } · the reader who waited now sees 95.00`,
  ...
  systemDesign: {
    question: 'Design separate read and write models. Premise: the command side appends to an event store, projections build query-side views, and the query side serves them, so read and write can scale and model independently.',
