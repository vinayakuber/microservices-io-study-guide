...
// <- outcome : hist : { request_ms: [41,37,48] } · three observe() calls are woven between the save() calls`
  ...
  systemDesign: {
    question: 'Design a metrics pipeline for services. Premise: an instrumented Order Service pushes or pulls metrics, Prometheus collects them, and a dashboard reads them, so operators watch each service\'s behavior live.',
